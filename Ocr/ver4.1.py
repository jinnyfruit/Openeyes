...
form = f"Please return only the correct text after figuring out whether it is Korean or English among the two texts.\n\n Korean:{result_kor} English:{result_eng}"
print(form)

selected_result = get_language(result_kor, result_eng, form)
print("\n---------chatGPT result---------")
